...
/*
		...
		this.restart = function() {			
			...
			link.enter().insert("line", ".node")
				.attr("class", "link")
				.style("stroke-width", function(d){return d.s;})
		...
		this.nodeParam = function(text,r,c,data){return {"text":text,"r":r,"c":c,"data":data};};
		...
		this.linkParam = function(sourceIndex,targetIndex,d,s,c,data){return {
