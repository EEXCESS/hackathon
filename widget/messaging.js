...
chrome.runtime.onMessage.addListener(
        function(request, sender, sendResponse) {
            if (request.method !== 'visibility' && request.method !== 'fancybox' && request.method !== 'useResource' && request.method !== 'getTextualContext' && request.method !== 'taskStarted' && request.method !== 'taskStopped' && request.method !== 'updateGraph') {
